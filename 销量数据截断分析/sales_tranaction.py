...
def analyze_sales_truncation(input_filepath, output_filepath, zero_days_threshold=14):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('plot_1_last_sale_distribution.png', dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('plot_2_booking_curves_comparison.png', dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('plot_3_scatter_sales_vs_last_rd.png', dpi=300)
    plt.close()
...
if __name__ == "__main__":
    ...
    input_file = "data_fam_products.csv"
    output_file = "data_fam_products_analyzed.csv"
