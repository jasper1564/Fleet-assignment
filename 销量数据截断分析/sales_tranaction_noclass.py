...
def analyze_flight_capacity_truncation(input_filepath, output_filepath, zero_days_threshold=14):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('flight_plot_1_last_sale_dist.png', dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('flight_plot_2_booking_curves.png', dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('flight_plot_3_capacity_ceiling.png', dpi=300)
    plt.close()
...
if __name__ == "__main__":
    ...
    output_file = "data_fam_flights_analyzed.csv"
